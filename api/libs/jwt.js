...
const secret = process.env.APP_TOKEN_SECRET || 'c196792a8a14be2d3f10646079001a37e634ebbd99643c543f';
// @link checkout https://github.com/auth0/node-jsonwebtoken#usage for ttl syntax
const ttl = Number(process.env.APP_TOKEN_TTL) ? Number(process.env.APP_TOKEN_TTL) : '7d';
